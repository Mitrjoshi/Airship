      ...
      <div className="p-10">
        <div className="flex flex-wrap justify-center items-center gap-6 mb-8">
          <Form {...form}>
            ...
            >
              {/* Form fields for workspace name, description, access key, secret access key, and agree checkbox */}
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 shadow">
                    ...
                    <div className="space-y-1 leading-none">
                      <FormLabel>
                        I agree to securely share my keys, acknowledging they
                        will be protected with the utmost security measures.
                      </FormLabel>
                    </div>
                  </FormItem>
                )}
